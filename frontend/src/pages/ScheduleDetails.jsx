...
const defaultScheduleData = [
  { icon: '💧', name: 'Drink the water', time: '07:00 AM' },
  { icon: '🚶‍♂️', name: 'Walk', time: '08:00 AM' },
  { icon: '🪴', name: 'Water Plants', time: '09:00 AM' },
  { icon: '🛌', name: 'Sleeping', time: '10:00 PM' },
  { icon: '🏃‍♂️', name: 'Running', time: '06:00 AM' },
  { icon: '🥗', name: 'Eat healthy', time: '12:30 PM' },
];

const ScheduleDetails = () => {
  const location = useLocation();
  const habits = (location.state && location.state.habits) ? location.state.habits : defaultScheduleData;
  return (
