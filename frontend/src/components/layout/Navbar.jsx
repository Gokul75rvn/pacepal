            ...
            {isAuthenticated ? (
              <div className="relative group">
                <button className="flex items-center space-x-2 focus:outline-none">
                  ...
                  <span className="text-dark font-medium hidden md:inline">
                    {user?.name}
                  </span>
                </button>
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 hidden group-hover:block z-10">
                  <DropdownItem
                    to="/settings"
                    icon={<FaCog />}
                    label="Settings"
